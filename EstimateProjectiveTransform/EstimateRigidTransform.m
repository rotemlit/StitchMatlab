function [Transform,debug] = EstimateRigidTransform(Image1,Image2,params,initialHomog)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
[Points2,status0] = cv.calcOpticalFlowPyrLK(Image1,Image2,Points1,'MaxLevel',3,'InitialFlow',initialPoints);
